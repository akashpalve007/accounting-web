...
class ShowInAdmin
{
    ...
    public function handle(Event $event)
    {
        ...
        // // Chart-Of-Accounts
        // $title_new = trim(trans_choice('Chart Of Accounts', 2));
        // if ($this->canAccessMenuItem($title_new, 'read-common-items')) {
        //     $menu->route('chartofaccounts.index', $title_new, [], 20, ['icon' => 'inventory_2']);
        // }

        // // Payroll
        // $title_new = trim(trans_choice('Payroll', 2));
        // if ($this->canAccessMenuItem($title_new, 'read-common-items')) {
        //     $menu->route('payroll.index', $title_new, [], 20, ['icon' => 'inventory_2']);
        // }
