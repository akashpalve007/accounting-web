<?php
use App\Http\Controllers\Common\Test1PageController;
use App\Http\Controllers\Common\chartofaccounts;
...
Route::group(['prefix' => 'common'], function () {
   ...
   // Route::get('/payroll', 'Common\PayrollController@index')->name('payroll.index');
    
  //  Route::get('/test1', [PayrollController::class, 'test1'])->name('test1.index');
    //Route::get('/payroll', 'Common\payrollController@index')->name('payroll.index');
    //Route::get('/item_new', 'Common\Test1PageController@index')->name('item_new.index');
   // Route::get('/chartofaccounts', 'Common\chartofaccountsController@index')->name('chartofaccounts.index');
});
